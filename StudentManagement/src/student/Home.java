...
public class Home extends javax.swing.JFrame {
    ...
    public void showJtable(){
         try{
            ...
            while(rs.next()){
                 Object objList[] = {rs.getInt("id"),rs.getString("name"),rs.getString("date_of_birth"),rs.getString("gender"),rs.getString("email"),rs.getString("phone"),rs.getInt("point"),rs.getString("monhoc"),rs.getString("address1"),rs.getString("address2")}; 
    ...
    public void insert(Student student){
        String sql = "INSERT INTO student (id, name, date_of_birth, gender, email, phone, point, monhoc, address1, address2) VALUES(?,?,?,?,?,?,?,?,?,?)";
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/student_management","root","quangcuon2k3");
            PreparedStatement ps = conn.prepareStatement(sql);
            ...
            ps.setInt(7, student.getPoint());
            ps.setString(8, student.getMonhoc());
    ...
    // hàm khi giáo viên thêm sinh viên thì sẽ tạo tk sinh viên
    ...
    public void update(Student student){
        String sql = "update student set name = ?,date_of_birth = ?,gender = ?,email = ?,phone = ?,"
                    +"point = ?, monhoc = ?, address1 = ?, address2 = ? WHERE id = ?";
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/student_management","root","quangcuon2k3");
            PreparedStatement ps = conn.prepareStatement(sql);
            ...
            ps.setInt(6, student.getPoint());
            ps.setString(7, student.getMonhoc());
    ...
    // update lại tk sinh viên khi thay đôi trường thông tin
    ...
    // khi giáo viên xóa sinh viên thì tk sinh viên tự xóa
    public void deleteSv(Student student){
        String sql = "delete from tksv where (id = ?)";
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/student_management","root","quangcuon2k3");
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setInt(1, student.getId());
    ...
    public boolean isEmptyStudent(){
        ...
        if(jDateChooser2.getDate().compareTo(new Date())>0){
            JOptionPane.showConfirmDialog(this, "Xuyên không à ");
            return false;
        ...
        if(jTextField5.getText().isEmpty()){
            JOptionPane.showConfirmDialog(this, "Thiếu điểm");
            return false;
        }
        if(Integer.parseInt(jTextField5.getText())>10 ||Integer.parseInt(jTextField5.getText())<0){
            JOptionPane.showConfirmDialog(this, "Điểm ko hợp lệ");
            return false;
        }
        if(jTextField6.getText().isEmpty()){
            JOptionPane.showConfirmDialog(this, "Thiếu môn học");
            return false;
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "HỌ VÀ TÊN", "NGÀY SINH", "GIỚI TÍNH", "GMAIL", "SĐT", "ĐIỂM", "MÔN HỌC", "QUÊ QUÁN", "NƠI CƯ TRÚ"
            }
        ));
   ...
   // even refresh
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        jTable1.setModel(new DefaultTableModel(null,new Object[]{"ID","HỌ VÀ TÊN","NGÀY SINH","GIỚI TÍNH","GMAIL","SĐT","ĐIỂM","MÔN HỌC","QUÊ QUÁN","NƠI CƯ TRÚ"}));
...
// even button "them"
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String monhoc = jTextField6.getText();
        ...
        if(isEmptyStudent()){
            try {
                if(!isID(jTextField1.getText())){
                    ...
                    student.setPoint(Integer.parseInt(diem));
...
//                     update lai tabel
                    model = (DefaultTableModel) jTable1.getModel();
                    model.addRow(new Object[]{id, hovaten, ngaysinhStr, gioitinh, gmail, sdt, diem, monhoc, quequan, noicutru});
...
// eve tìm kiếm 
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(searchField.getText().isEmpty()){
            ...
            jTable1.setModel(new DefaultTableModel(null,new Object[]{"ID","HỌ VÀ TÊN","NGÀY SINH","GIỚI TÍNH","GMAIL","SĐT","ĐIỂM","MÔN HỌC","QUÊ QUÁN","NƠI CƯ TRÚ"}));
            getStudentValue(jTable1, searchField.getText());
        }
